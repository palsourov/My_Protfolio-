  ...
  <div className="lg:w-[70%] mx-auto flex flex-col md:flex-row items-center md:space-x-10">
    ...
    >
      <p className="text-gray-300 mb-4 text-lg md:text-xl leading-relaxed">
        I'm a <span className="text-emerald-400 font-semibold">Computer Science and Engineering graduate</span> and a Sales Associate at <span className="text-indigo-400 font-semibold">MKI Outsource</span>. I specialize in lead generation, client communication, product demonstrations, and CRM-based customer engagement, combining technical knowledge with sales experience.
      </p>

      <p className="text-gray-300 mb-4 text-lg md:text-xl leading-relaxed">
        My technical background in <span className="text-emerald-400 font-semibold">web development and modern technologies</span> supports my interest in <span className="text-yellow-400 font-semibold">Digital Marketing</span>, particularly SEO, SEM, AEO, marketing optimization, and building meaningful customer relationships.
      </p>
